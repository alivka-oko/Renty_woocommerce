...
<main class="main">
        ...
        <div class="container">
            <div class="content">
                <div class="headline">
                    ...
                    <a href="<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>" class="link-accent">Все предложения</a>
                </div>
                <div class="cards">
                    <?php
                    $args = array(
    ...
    <section class="section banner-ad">
        <div class="container">
            <div class="content">
                <a class="advertisement" href="#" style="background:url('http://renty/wp-content/uploads/2024/05/advertisement.png')"></a>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="#" class="article card">
                                    <img src="http://renty/wp-content/uploads/2024/04/road-sport-vintage-wheel-retro-old-scaled.jpg" alt="">
                                    <h5 class="text-sub">Финансы</h5>
                                    <p class="text">Как изменятся цены на московское жилье к началу 2023 года. Как можно к этому подготовиться?</p>
